...
export default function MuestraTipo3Modal({ visible, onClose, onGuardar, valoresIniciales = { dato_1: '', dato_2: '', dato_3: '', dato_4: '', coordenada: '' }, esEdicion = false }) {
          ...
          <View style={styles.modalContainer}>
            <View style={styles.header}>
              <Text style={styles.titulo}>
                {esEdicion ? 'Editar Muestra R4-R7' : 'Nueva Muestra R4-R7'}
              </Text>
              <TouchableOpacity 
