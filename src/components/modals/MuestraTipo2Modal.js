...
export default function MuestraTipo2Modal({ visible, onClose, onGuardar, valoresIniciales = { dato_1: '', dato_2: '', dato_3: '', dato_4: '' } }) {
        ...
        <KeyboardAvoidingView behavior={'padding'} style={styles.avoider}>
          <View style={styles.modalContainer}>
            <View style={styles.header}>
              <Text style={styles.titulo}>Muestra Tipo 2</Text>
